  ...
  useEffect(() => {
    async function fetchCarreras() {
      ...
      try {
        ...
        console.log('carreras de firebase (dashboard):', results.length);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.searchBox}>
          ...
          <TextInput
            ...
            placeholder="Buscar por carrera (API Real)..."
        ...
        {loading ? (
          ...
          <View>
            ...
            {carrerasFirebase.length === 0 && (
              <Text style={styles.emptyText}>No se encontraron carreras en la Base de Datos.</Text>
            )}
          </View>
        )}
